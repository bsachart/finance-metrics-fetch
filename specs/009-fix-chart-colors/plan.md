...
|-----------|------------|-------------------------------------|
| [e.g., extra service boundary] | [current need] | [why a simpler module was insufficient] |
| [e.g., additional abstraction] | [specific problem] | [why direct implementation was not enough] |
